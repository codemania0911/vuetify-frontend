  ...
  >
    ...
    >
        ...
        >
          ...
          >
            <template v-slot:badge>
              <span>{{ alertItems.alerts[1] && alertItems.alerts[1].length }}</span>
            </template>
      ...
      <v-list
        ...
        nav
      >
        <div v-if="alertItems.alerts[1]">
          <div
            v-for="(notification, i) in alertItems.alerts[1]"
            :key="`item-${i}`"
          >
            <app-bar-item
        ...
        <!-- <div v-if="alertItems.alerts[2]">
          <div
            v-for="(ais_status, i) in alertItems.alerts[2]"
            :key="`item-${i}`"
          >
            <app-bar-item
