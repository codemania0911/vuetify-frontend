...
<script>
  ...
  import { pinDropsLayer } from './mixins/pinDropsLayer'
  ...
  export default {
    ...
    methods: {
      ...
      async exportKML () {
        ...
        try {
          const response = await axios.get(`map/export/CDT.kml/${JSON.stringify(filters)}`, { responseType: 'arraybuffer' })
          download(response.data, 'CDT.kml')
          this.showSnackBar({
