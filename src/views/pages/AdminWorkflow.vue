  ...
  >
    ...
    >
      ...
      >
        ...
        <div class="text-h4 font-weight-light grey--text text--lighten-2">
      ...
      >
        <v-card
          ...
          :light="plan.best"
          class="v-card--plan pt-3 pb-4 px-2 text-center"
          max-width="280px"
          width="100%"
          @click="activeBox(i)"
        >
          <div
            class="text-body-2 text-uppercase grey--text mb-7"
            v-text="plan.heading"
          />
          <v-progress-linear
          ...
          <h2
            class="text-h3 font-weight-light px-7"
            style="margin: 40px 0;"
            v-text="plan.title"
          />
...
<script>
  ...
  import { OIL_GROUP, MIXINS } from '@/shared/constants'
  ...
  export default {
    components: {
      ...
      AddPlan: () => import('../dashboard/components/forms/AddPlan'),
    },
    ...
    computed: {
      ...
      selectedItems () {
        const items = [
          { category: 'company_name', items: this.mixinItems.companies, label: 'Company Name', icon: 'mdi-domain' },
          { category: 'country_name', items: this.mixinItems.countries, label: 'Country Name', icon: 'mdi-map-marker' },
          { category: 'vessel_type', items: this.mixinItems.vesselTypes, label: 'Vessel Type', icon: 'mdi-tag' },
          { category: 'class', items: this.mixinItems.societies, label: 'Class', icon: 'mdi-axis-arrow-lock' },
          { category: 'pi_club', items: this.mixinItems.pis, label: 'P&I Club', icon: 'mdi-umbrella' },
          { category: 'hm_insurer', items: this.mixinItems.insurers, label: 'H&M Insurer', icon: 'mdi-engine' },
          { category: 'oil_group', items: OIL_GROUP.map(oil => ({ id: oil, name: oil })), label: 'Oil Group', icon: 'mdi-oil' },
          { category: 'damage_stability', items: this.mixinItems.providers, label: 'Damage Stability', icon: 'mdi-chart-bell-curve' },
        ]
